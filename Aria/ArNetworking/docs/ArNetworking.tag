...
<tagfile>
  ...
  <compound kind="page">
    ...
    <docanchor file="RemoteRequestAPI" title="data in a client with ArClientDataReceiver">Receiving</docanchor>
    <docanchor file="RemoteRequestAPI" title="request methods in ArClientBase">Manual</docanchor>
    ...
    <docanchor file="RemoteRequestAPI" title="ARNL and MOGS Autonomous Navigation, Go To Goal Commands">ARNL</docanchor>
  </compound>
  <compound kind="page">
    <name>index</name>
