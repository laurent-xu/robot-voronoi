...
Copyright 2016-2017 Omron Adept Technologies, Inc. All rights reserved.
...
For example, if you unpacked ARIA-2.9.3.tgz in you home directory 
and compiled ARIA, then use this command:
   export DYLD_LIBRARY_PATH=$DYLD_LIBRARY_PATH:~/Aria-2.9.3/lib
