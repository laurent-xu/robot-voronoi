...
public class ArACTS_1_2 {
  ...
  public final static class ActsConstants {
    public final static ArACTS_1_2.ActsConstants NUM_CHANNELS = new ArACTS_1_2.ActsConstants("NUM_CHANNELS", AriaJavaJNI.ArACTS_1_2_NUM_CHANNELS_get());
    public final static ArACTS_1_2.ActsConstants MAX_BLOBS = new ArACTS_1_2.ActsConstants("MAX_BLOBS", AriaJavaJNI.ArACTS_1_2_MAX_BLOBS_get());
    public final static ArACTS_1_2.ActsConstants ACTS_BLOB_DATA_SIZE = new ArACTS_1_2.ActsConstants("ACTS_BLOB_DATA_SIZE", AriaJavaJNI.ArACTS_1_2_ACTS_BLOB_DATA_SIZE_get());
    public final static ArACTS_1_2.ActsConstants DATA_HEADER = new ArACTS_1_2.ActsConstants("DATA_HEADER", AriaJavaJNI.ArACTS_1_2_DATA_HEADER_get());
    public final static ArACTS_1_2.ActsConstants MAX_DATA = new ArACTS_1_2.ActsConstants("MAX_DATA", AriaJavaJNI.ArACTS_1_2_MAX_DATA_get());
