...
public class ArActionColorFollow extends ArAction {
  ...
  public final static class TargetState {
    public final static ArActionColorFollow.TargetState NO_TARGET = new ArActionColorFollow.TargetState("NO_TARGET");
    public final static ArActionColorFollow.TargetState TARGET = new ArActionColorFollow.TargetState("TARGET");
  ...
  public final static class MoveState {
    public final static ArActionColorFollow.MoveState FOLLOWING = new ArActionColorFollow.MoveState("FOLLOWING");
    public final static ArActionColorFollow.MoveState ACQUIRING = new ArActionColorFollow.MoveState("ACQUIRING");
    public final static ArActionColorFollow.MoveState STOPPED = new ArActionColorFollow.MoveState("STOPPED");
  ...
  public final static class LocationState {
    public final static ArActionColorFollow.LocationState LEFT = new ArActionColorFollow.LocationState("LEFT");
    public final static ArActionColorFollow.LocationState RIGHT = new ArActionColorFollow.LocationState("RIGHT");
    public final static ArActionColorFollow.LocationState CENTER = new ArActionColorFollow.LocationState("CENTER");
