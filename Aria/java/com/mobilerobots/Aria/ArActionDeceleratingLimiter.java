...
public class ArActionDeceleratingLimiter extends ArAction {
  ...
  public final static class LimiterType {
    public final static ArActionDeceleratingLimiter.LimiterType FORWARDS = new ArActionDeceleratingLimiter.LimiterType("FORWARDS");
    public final static ArActionDeceleratingLimiter.LimiterType BACKWARDS = new ArActionDeceleratingLimiter.LimiterType("BACKWARDS");
    public final static ArActionDeceleratingLimiter.LimiterType LATERAL_LEFT = new ArActionDeceleratingLimiter.LimiterType("LATERAL_LEFT");
    public final static ArActionDeceleratingLimiter.LimiterType LATERAL_RIGHT = new ArActionDeceleratingLimiter.LimiterType("LATERAL_RIGHT");
