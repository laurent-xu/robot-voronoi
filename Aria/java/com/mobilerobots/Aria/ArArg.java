...
public class ArArg {
  ...
  public final static class Type {
    public final static ArArg.Type INVALID = new ArArg.Type("INVALID");
    public final static ArArg.Type INT = new ArArg.Type("INT");
    public final static ArArg.Type DOUBLE = new ArArg.Type("DOUBLE");
    public final static ArArg.Type STRING = new ArArg.Type("STRING");
    public final static ArArg.Type BOOL = new ArArg.Type("BOOL");
    public final static ArArg.Type POSE = new ArArg.Type("POSE");
    public final static ArArg.Type FUNCTOR = new ArArg.Type("FUNCTOR");
    public final static ArArg.Type DESCRIPTION_HOLDER = new ArArg.Type("DESCRIPTION_HOLDER");
    public final static ArArg.Type LAST_TYPE = new ArArg.Type("LAST_TYPE", AriaJavaJNI.ArArg_LAST_TYPE_get());
