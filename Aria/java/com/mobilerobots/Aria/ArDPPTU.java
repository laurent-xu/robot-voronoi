...
public class ArDPPTU extends ArPTZ {
  ...
  public final static class DeviceType {
    public final static ArDPPTU.DeviceType PANTILT_DEFAULT = new ArDPPTU.DeviceType("PANTILT_DEFAULT");
    public final static ArDPPTU.DeviceType PANTILT_PTUD47 = new ArDPPTU.DeviceType("PANTILT_PTUD47");
    public final static ArDPPTU.DeviceType PANTILT_PTUD46 = new ArDPPTU.DeviceType("PANTILT_PTUD46");
  ...
  public final static class Axis {
    public final static ArDPPTU.Axis PAN = new ArDPPTU.Axis("PAN", AriaJavaJNI.ArDPPTU_PAN_get());
    public final static ArDPPTU.Axis TILT = new ArDPPTU.Axis("TILT", AriaJavaJNI.ArDPPTU_TILT_get());
  ...
  public final static class PowerMode {
    public final static ArDPPTU.PowerMode OFF = new ArDPPTU.PowerMode("OFF", AriaJavaJNI.ArDPPTU_OFF_get());
    public final static ArDPPTU.PowerMode LOW = new ArDPPTU.PowerMode("LOW", AriaJavaJNI.ArDPPTU_LOW_get());
    public final static ArDPPTU.PowerMode NORMAL = new ArDPPTU.PowerMode("NORMAL", AriaJavaJNI.ArDPPTU_NORMAL_get());
    public final static ArDPPTU.PowerMode HIGH = new ArDPPTU.PowerMode("HIGH", AriaJavaJNI.ArDPPTU_HIGH_get());
