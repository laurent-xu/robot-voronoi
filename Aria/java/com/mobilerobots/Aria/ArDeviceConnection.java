...
public class ArDeviceConnection {
  ...
  public final static class Status {
    public final static ArDeviceConnection.Status STATUS_NEVER_OPENED = new ArDeviceConnection.Status("STATUS_NEVER_OPENED", AriaJavaJNI.ArDeviceConnection_STATUS_NEVER_OPENED_get());
    public final static ArDeviceConnection.Status STATUS_OPEN = new ArDeviceConnection.Status("STATUS_OPEN");
    public final static ArDeviceConnection.Status STATUS_OPEN_FAILED = new ArDeviceConnection.Status("STATUS_OPEN_FAILED");
    public final static ArDeviceConnection.Status STATUS_CLOSED_NORMALLY = new ArDeviceConnection.Status("STATUS_CLOSED_NORMALLY");
    public final static ArDeviceConnection.Status STATUS_CLOSED_ERROR = new ArDeviceConnection.Status("STATUS_CLOSED_ERROR");
