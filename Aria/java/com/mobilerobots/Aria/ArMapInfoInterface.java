...
public class ArMapInfoInterface {
  ...
  public final static class InfoType {
    public final static ArMapInfoInterface.InfoType MAP_INFO = new ArMapInfoInterface.InfoType("MAP_INFO");
    public final static ArMapInfoInterface.InfoType FIRST_INFO = new ArMapInfoInterface.InfoType("FIRST_INFO", AriaJavaJNI.ArMapInfoInterface_FIRST_INFO_get());
    public final static ArMapInfoInterface.InfoType MACRO_INFO = new ArMapInfoInterface.InfoType("MACRO_INFO");
    public final static ArMapInfoInterface.InfoType META_INFO = new ArMapInfoInterface.InfoType("META_INFO");
    public final static ArMapInfoInterface.InfoType TASK_INFO = new ArMapInfoInterface.InfoType("TASK_INFO");
    public final static ArMapInfoInterface.InfoType ROUTE_INFO = new ArMapInfoInterface.InfoType("ROUTE_INFO");
    public final static ArMapInfoInterface.InfoType SCHED_TASK_INFO = new ArMapInfoInterface.InfoType("SCHED_TASK_INFO");
    public final static ArMapInfoInterface.InfoType SCHED_INFO = new ArMapInfoInterface.InfoType("SCHED_INFO");
    public final static ArMapInfoInterface.InfoType CAIRN_INFO = new ArMapInfoInterface.InfoType("CAIRN_INFO");
    public final static ArMapInfoInterface.InfoType CUSTOM_INFO = new ArMapInfoInterface.InfoType("CUSTOM_INFO");
    public final static ArMapInfoInterface.InfoType LAST_INFO = new ArMapInfoInterface.InfoType("LAST_INFO", AriaJavaJNI.ArMapInfoInterface_LAST_INFO_get());
