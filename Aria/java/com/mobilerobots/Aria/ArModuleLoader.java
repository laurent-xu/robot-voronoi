...
public class ArModuleLoader {
  ...
  public final static class Status {
    public final static ArModuleLoader.Status STATUS_SUCCESS = new ArModuleLoader.Status("STATUS_SUCCESS", AriaJavaJNI.ArModuleLoader_STATUS_SUCCESS_get());
    public final static ArModuleLoader.Status STATUS_ALREADY_LOADED = new ArModuleLoader.Status("STATUS_ALREADY_LOADED");
    public final static ArModuleLoader.Status STATUS_FAILED_OPEN = new ArModuleLoader.Status("STATUS_FAILED_OPEN");
    public final static ArModuleLoader.Status STATUS_INVALID = new ArModuleLoader.Status("STATUS_INVALID");
    public final static ArModuleLoader.Status STATUS_INIT_FAILED = new ArModuleLoader.Status("STATUS_INIT_FAILED");
    public final static ArModuleLoader.Status STATUS_EXIT_FAILED = new ArModuleLoader.Status("STATUS_EXIT_FAILED");
    public final static ArModuleLoader.Status STATUS_NOT_FOUND = new ArModuleLoader.Status("STATUS_NOT_FOUND");
