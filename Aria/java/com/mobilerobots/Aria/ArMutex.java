...
public class ArMutex {
  ...
  public final static class Status {
    public final static ArMutex.Status STATUS_FAILED_INIT = new ArMutex.Status("STATUS_FAILED_INIT", AriaJavaJNI.ArMutex_STATUS_FAILED_INIT_get());
    public final static ArMutex.Status STATUS_FAILED = new ArMutex.Status("STATUS_FAILED");
    public final static ArMutex.Status STATUS_ALREADY_LOCKED = new ArMutex.Status("STATUS_ALREADY_LOCKED");
