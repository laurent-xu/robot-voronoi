...
public class ArP2Arm {
  ...
  public final static class State {
    public final static ArP2Arm.State SUCCESS = new ArP2Arm.State("SUCCESS");
    public final static ArP2Arm.State ALREADY_INITED = new ArP2Arm.State("ALREADY_INITED");
    public final static ArP2Arm.State NOT_INITED = new ArP2Arm.State("NOT_INITED");
    public final static ArP2Arm.State ROBOT_NOT_SETUP = new ArP2Arm.State("ROBOT_NOT_SETUP");
    public final static ArP2Arm.State NO_ARM_FOUND = new ArP2Arm.State("NO_ARM_FOUND");
    public final static ArP2Arm.State COMM_FAILED = new ArP2Arm.State("COMM_FAILED");
    public final static ArP2Arm.State COULD_NOT_OPEN_PORT = new ArP2Arm.State("COULD_NOT_OPEN_PORT");
    public final static ArP2Arm.State COULD_NOT_SET_UP_PORT = new ArP2Arm.State("COULD_NOT_SET_UP_PORT");
    public final static ArP2Arm.State ALREADY_CONNECTED = new ArP2Arm.State("ALREADY_CONNECTED");
    public final static ArP2Arm.State NOT_CONNECTED = new ArP2Arm.State("NOT_CONNECTED");
    public final static ArP2Arm.State INVALID_JOINT = new ArP2Arm.State("INVALID_JOINT");
    public final static ArP2Arm.State INVALID_POSITION = new ArP2Arm.State("INVALID_POSITION");
  ...
  public final static class PacketType {
    public final static ArP2Arm.PacketType StatusPacket = new ArP2Arm.PacketType("StatusPacket");
    public final static ArP2Arm.PacketType InfoPacket = new ArP2Arm.PacketType("InfoPacket");
  ...
  public final static class StatusType {
    public final static ArP2Arm.StatusType StatusOff = new ArP2Arm.StatusType("StatusOff", AriaJavaJNI.ArP2Arm_StatusOff_get());
    public final static ArP2Arm.StatusType StatusSingle = new ArP2Arm.StatusType("StatusSingle", AriaJavaJNI.ArP2Arm_StatusSingle_get());
    public final static ArP2Arm.StatusType StatusContinuous = new ArP2Arm.StatusType("StatusContinuous", AriaJavaJNI.ArP2Arm_StatusContinuous_get());
