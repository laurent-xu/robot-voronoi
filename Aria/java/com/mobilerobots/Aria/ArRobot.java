...
public class ArRobot {
  ...
  public final static class WaitState {
    public final static ArRobot.WaitState WAIT_CONNECTED = new ArRobot.WaitState("WAIT_CONNECTED");
    public final static ArRobot.WaitState WAIT_FAILED_CONN = new ArRobot.WaitState("WAIT_FAILED_CONN");
    public final static ArRobot.WaitState WAIT_RUN_EXIT = new ArRobot.WaitState("WAIT_RUN_EXIT");
    public final static ArRobot.WaitState WAIT_TIMEDOUT = new ArRobot.WaitState("WAIT_TIMEDOUT");
    public final static ArRobot.WaitState WAIT_INTR = new ArRobot.WaitState("WAIT_INTR");
    public final static ArRobot.WaitState WAIT_FAIL = new ArRobot.WaitState("WAIT_FAIL");
  ...
  public final static class ChargeState {
    public final static ArRobot.ChargeState CHARGING_UNKNOWN = new ArRobot.ChargeState("CHARGING_UNKNOWN", AriaJavaJNI.ArRobot_CHARGING_UNKNOWN_get());
    public final static ArRobot.ChargeState CHARGING_NOT = new ArRobot.ChargeState("CHARGING_NOT", AriaJavaJNI.ArRobot_CHARGING_NOT_get());
    public final static ArRobot.ChargeState CHARGING_BULK = new ArRobot.ChargeState("CHARGING_BULK", AriaJavaJNI.ArRobot_CHARGING_BULK_get());
    public final static ArRobot.ChargeState CHARGING_OVERCHARGE = new ArRobot.ChargeState("CHARGING_OVERCHARGE", AriaJavaJNI.ArRobot_CHARGING_OVERCHARGE_get());
    public final static ArRobot.ChargeState CHARGING_FLOAT = new ArRobot.ChargeState("CHARGING_FLOAT", AriaJavaJNI.ArRobot_CHARGING_FLOAT_get());
    public final static ArRobot.ChargeState CHARGING_BALANCE = new ArRobot.ChargeState("CHARGING_BALANCE", AriaJavaJNI.ArRobot_CHARGING_BALANCE_get());
