...
public class ArSerialConnection extends ArDeviceConnection {
  ...
  public final static class Open {
    public final static ArSerialConnection.Open OPEN_COULD_NOT_OPEN_PORT = new ArSerialConnection.Open("OPEN_COULD_NOT_OPEN_PORT", AriaJavaJNI.ArSerialConnection_OPEN_COULD_NOT_OPEN_PORT_get());
    public final static ArSerialConnection.Open OPEN_COULD_NOT_SET_UP_PORT = new ArSerialConnection.Open("OPEN_COULD_NOT_SET_UP_PORT");
    public final static ArSerialConnection.Open OPEN_INVALID_BAUD_RATE = new ArSerialConnection.Open("OPEN_INVALID_BAUD_RATE");
    public final static ArSerialConnection.Open OPEN_COULD_NOT_SET_BAUD = new ArSerialConnection.Open("OPEN_COULD_NOT_SET_BAUD");
    public final static ArSerialConnection.Open OPEN_ALREADY_OPEN = new ArSerialConnection.Open("OPEN_ALREADY_OPEN");
