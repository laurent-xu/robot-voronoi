...
public class ArSocket {
  ...
  public final static class Type {
    public final static ArSocket.Type UDP = new ArSocket.Type("UDP");
    public final static ArSocket.Type TCP = new ArSocket.Type("TCP");
    public final static ArSocket.Type Unknown = new ArSocket.Type("Unknown");
  ...
  public final static class Error {
    public final static ArSocket.Error NoErr = new ArSocket.Error("NoErr");
    public final static ArSocket.Error NetFail = new ArSocket.Error("NetFail");
    public final static ArSocket.Error ConBadHost = new ArSocket.Error("ConBadHost");
    public final static ArSocket.Error ConNoRoute = new ArSocket.Error("ConNoRoute");
    public final static ArSocket.Error ConRefused = new ArSocket.Error("ConRefused");
    public final static ArSocket.Error NameLookup = new ArSocket.Error("NameLookup");
