...
public class ArTcpConnection extends ArDeviceConnection {
  ...
  public final static class Open {
    public final static ArTcpConnection.Open OPEN_NET_FAIL = new ArTcpConnection.Open("OPEN_NET_FAIL", AriaJavaJNI.ArTcpConnection_OPEN_NET_FAIL_get());
    public final static ArTcpConnection.Open OPEN_BAD_HOST = new ArTcpConnection.Open("OPEN_BAD_HOST");
    public final static ArTcpConnection.Open OPEN_NO_ROUTE = new ArTcpConnection.Open("OPEN_NO_ROUTE");
    public final static ArTcpConnection.Open OPEN_CON_REFUSED = new ArTcpConnection.Open("OPEN_CON_REFUSED");
