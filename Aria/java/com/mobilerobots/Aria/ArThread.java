...
public class ArThread {
  ...
  public final static class Status {
    public final static ArThread.Status STATUS_FAILED = new ArThread.Status("STATUS_FAILED", AriaJavaJNI.ArThread_STATUS_FAILED_get());
    public final static ArThread.Status STATUS_NORESOURCE = new ArThread.Status("STATUS_NORESOURCE");
    public final static ArThread.Status STATUS_NO_SUCH_THREAD = new ArThread.Status("STATUS_NO_SUCH_THREAD");
    public final static ArThread.Status STATUS_INVALID = new ArThread.Status("STATUS_INVALID");
    public final static ArThread.Status STATUS_JOIN_SELF = new ArThread.Status("STATUS_JOIN_SELF");
    public final static ArThread.Status STATUS_ALREADY_DETATCHED = new ArThread.Status("STATUS_ALREADY_DETATCHED");
