...
public class ArVersalogicIO {
  ...
  public final static class Direction {
    public final static ArVersalogicIO.Direction DIGITAL_INPUT = new ArVersalogicIO.Direction("DIGITAL_INPUT");
    public final static ArVersalogicIO.Direction DIGITAL_OUTPUT = new ArVersalogicIO.Direction("DIGITAL_OUTPUT");
