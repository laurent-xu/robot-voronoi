...
//#define STG_F() { strncpy(stg_last_function, __PRETTY_FUNCTION__, 127); stg_last_function[127] = '\0'; }
//#define STG_XF(f) { strncpy(stg_last_function, f, 127); stg_last_function[127] = '\0'; }
#define STG_F() { }
#define STG_XF(f) { }
